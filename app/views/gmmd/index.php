...
<div class="container">
    <main>
        <div class="hero">
            <div class="hero-contents">
                <video controls align="left" autoplay muted>
                    <source src="<?= ASSETS.THEME ?>images/video.mp4" type="video/mp4"/>
                    <source src="<?= ASSETS .THEME?>movie.ogg" type="video/ogg"/>
                    Your browser does not support the video tag.
                </video>
                <div class="hero-text">
                    <h1>Grain-Mill Market and Delivery</h1>
                    <h2>Get it Milled.</h2>
                    <a href="<?= ROOT ?>market">Shop Now</a>
        ...
        <div id="about">
            ...
            <div class="container">
                <div class="about-img">
                    <img src="<?= ASSETS.THEME ?>img/about.png" alt="about" usemap="#image-map"/>
            ...
            <div class="container">
                ...
                <div class="section">
                    <div class="gallery-section" align="center">
                        <img src="<?= ASSETS.THEME ?>images/gallery/1.jpg" alt=""/>
                        <img src="<?= ASSETS.THEME ?>images/gallery/2.jpg" alt=""/>
                        <img src="<?= ASSETS.THEME ?>images/gallery/3.jpg" alt=""/>
                    </div>
                </div>
            </div>
        </div>
